...
type TermsSection = {
  ...
  closingParagraph?: ReactNode
}

const OVERVIEW_PARAGRAPHS = [
  'This website is operated by teavision.com.au. Throughout the site, the terms “we”, “us” and “our” refer to teavision.com.au. Teavision offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.',
...
const TERMS_SECTIONS: readonly TermsSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      <>
        ...
        are subject to return or exchange only according to our{' '}
        <Link href="/pages/refund-policy" className={LINK_CLASS_NAME}>
          Return Policy
        </Link>
        .
      </>,
  ...
  },
  {
    ...
    paragraphs: [
      <>
        ...
        our{' '}
        <Link href="/pages/privacy-policy" className={LINK_CLASS_NAME}>
          Privacy Policy
        </Link>
        .
      </>,
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'In no case will teavision.com.au or our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers, or licensors be liable for injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including lost profits, revenue, savings, or data, replacement costs, or similar damages, whether based in contract, tort (including negligence), strict liability, or otherwise, arising from your use of the Service or products procured through it, or for any claim related to your use of the Service or a product. This includes errors or omissions in content and loss or damage arising from content or products posted, transmitted, or otherwise made available through the Service, even if advised of the possibility. Because some jurisdictions do not allow the exclusion or limitation of liability for consequential or incidental damages, our liability in those jurisdictions is limited to the maximum extent permitted by law.',
    ],
  },
  {
    id: 'indemnification',
  ...
  },
  {
    ...
    paragraphs: [
      <>
        ...
        <Link href="mailto:info@teavision.com.au" className={LINK_CLASS_NAME}>
    ...
    <Section.Root tone="surface">
      <Section.Container>
        <div className="max-w-prose">
          <h1 id="terms-of-service-title" className="type-heading-02 text-ink">
            {policy.title}
          </h1>
          ...
          >
            <section aria-labelledby="terms-overview-heading">
              <h2
              ...
              {OVERVIEW_PARAGRAPHS.map((paragraph, index) => (
                <p
                  key={`overview-${index}`}
                  className="type-body text-ink-soft mt-4"
                >
                  {paragraph}
                </p>
              ))}
            ...
            {TERMS_SECTIONS.map((section) => (
              ...
              >
                ...
                {section.list?.kind === 'ordered' ? (
                  <ol className="type-body text-ink-soft mt-4 list-decimal space-y-2 pl-6">
                    {section.list.items.map((item) => (
                      <li key={item}>{item}</li>
                    ))}
                  </ol>
                ) : section.list?.kind === 'unordered' ? (
                  <ul className="type-body text-ink-soft mt-4 list-none space-y-2">
                    {section.list.items.map((item) => (
                      <li key={item}>{item}</li>
                    ))}
                  </ul>
